 ...
 * 2019-05-20T14:27:26.284-03:00
 * Generated source version: 3.3.0
 *
 */
public final class CalcPrecoPrazoWSSoap_CalcPrecoPrazoWSSoap12_Client {

    private static final QName SERVICE_NAME = new QName("http://tempuri.org/", "CalcPrecoPrazoWS");

    private CalcPrecoPrazoWSSoap_CalcPrecoPrazoWSSoap12_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        CalcPrecoPrazoWSSoap port = ss.getCalcPrecoPrazoWSSoap12();
        ...
        int _calcPreco_nCdFormato = 0;
        java.math.BigDecimal _calcPreco_nVlComprimento = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPreco_nVlAltura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPreco_nVlLargura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPreco_nVlDiametro = new java.math.BigDecimal("0");
        java.lang.String _calcPreco_sCdMaoPropria = "";
        java.math.BigDecimal _calcPreco_nVlValorDeclarado = new java.math.BigDecimal("0");
        ...
        int _calcPrecoPrazo_nCdFormato = 0;
        java.math.BigDecimal _calcPrecoPrazo_nVlComprimento = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazo_nVlAltura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazo_nVlLargura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazo_nVlDiametro = new java.math.BigDecimal("0");
        java.lang.String _calcPrecoPrazo_sCdMaoPropria = "";
        java.math.BigDecimal _calcPrecoPrazo_nVlValorDeclarado = new java.math.BigDecimal("0");
        ...
        int _calcPrecoPrazoRestricao_nCdFormato = 0;
        java.math.BigDecimal _calcPrecoPrazoRestricao_nVlComprimento = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoRestricao_nVlAltura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoRestricao_nVlLargura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoRestricao_nVlDiametro = new java.math.BigDecimal("0");
        java.lang.String _calcPrecoPrazoRestricao_sCdMaoPropria = "";
        java.math.BigDecimal _calcPrecoPrazoRestricao_nVlValorDeclarado = new java.math.BigDecimal("0");
        ...
        int _calcPrecoPrazoData_nCdFormato = 0;
        java.math.BigDecimal _calcPrecoPrazoData_nVlComprimento = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoData_nVlAltura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoData_nVlLargura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoPrazoData_nVlDiametro = new java.math.BigDecimal("0");
        java.lang.String _calcPrecoPrazoData_sCdMaoPropria = "";
        java.math.BigDecimal _calcPrecoPrazoData_nVlValorDeclarado = new java.math.BigDecimal("0");
        ...
        int _calcPrecoData_nCdFormato = 0;
        java.math.BigDecimal _calcPrecoData_nVlComprimento = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoData_nVlAltura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoData_nVlLargura = new java.math.BigDecimal("0");
        java.math.BigDecimal _calcPrecoData_nVlDiametro = new java.math.BigDecimal("0");
        java.lang.String _calcPrecoData_sCdMaoPropria = "";
        java.math.BigDecimal _calcPrecoData_nVlValorDeclarado = new java.math.BigDecimal("0");
